        ...
        <div className="w-full justify-center items-center gap-8 grid grid-cols-1">
          <div className="w-full flex-col justify-center items-center gap-10 inline-flex">
            <div className="w-full flex-col justify-center items-center gap-4 flex">
              <h2 className="text-gray-900 text-3xl font-bold font-manrope leading-normal text-center">
                  ...
                  >
                    <div className="flex min-w-0 gap-x-4">
                      <img
                        alt=""
                        src={service.img_url}
                        className="size-48 object-cover flex-none rounded-full bg-gray-50"
                      />
          ...
          <div className="mx-auto h-full rounded-3xl object-cover"></div>
        </div>
      </div>
    </div>
  );
